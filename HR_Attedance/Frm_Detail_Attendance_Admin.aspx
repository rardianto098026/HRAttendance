<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Frm_Detail_Attendance_Admin.aspx.vb" Inherits="HR_Attedance.Frm_Detail_Attendance_Admin" %>
         ...
         <table width="100%" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
              ...
              <td class="style1" height="30" align ="left">
                  ...
                  <asp:TextBox ID="txtFirstSignIn2" runat="server" style="margin-left:91px" AutoPostBack="true" OnTextChanged ="txtFirstSignIn2_TextChanged"></asp:TextBox>
                  <asp:Label ID="lblTimeSignIn1" runat="server" Text="First Sign In Time" style="margin-left:15px"></asp:Label>
                  <asp:TextBox ID="txtTimeSignIn2" runat="server" style="margin-left:20px" AutoPostBack="true" OnTextChanged ="txtTimeSignIn2_TextChanged"></asp:TextBox>
                  <b><asp:Label ID="lblTimeFormat" runat="server" Text="Format hh:mm" style="margin-left:20px"></asp:Label></b>
          ...
          <tr>
              ...
              <td class="style1" height="30" align ="left">
                  ...
                  <asp:TextBox ID="txtSignOut2" runat="server" style="margin-left:82px" AutoPostBack="true" OnTextChanged="txtSignOut2_TextChanged"></asp:TextBox>
                  <asp:Label ID="lblTimeSignOut" runat="server" Text="Last Sign Out Time" style="margin-left:15px"></asp:Label>
                  <asp:TextBox ID="txtTimeSignOut" runat="server" style="margin-left:13px" AutoPostBack="true" OnTextChanged="txtTimeSignOut_TextChanged"></asp:TextBox>  
          ...
          <tr>
              ...
              <td class="style1" height="30" align ="left">
                  ...
                  <asp:Label ID="lblTypeofDays1" runat="server" Text="Type Of Days" style="margin-left:47px"></asp:Label>
                  <asp:Label ID="lblTypeofDays2" runat="server" style="margin-left:17px"></asp:Label>
              </td>
               <td background="Images/borderRight.gif" width="21">
                        &nbsp;</td>
          </tr>
          ...
          <tr>
              ...
              <td class="style1" height="30" align ="left">
                  ...
                  <asp:Label ID="lblWorkingStatus1" runat="server" Text="Working Status" style="margin-left:58px"></asp:Label>
          ...
          <tr>
              ...
              <td class="style1" height="30" align ="left">
                  ...
                  <asp:Label ID="lblOvertime1" runat="server" Text="Overtime" style="margin-left:65px"></asp:Label>
                  <asp:Label ID="lblOvertime2" runat="server" style="margin-left:39px"></asp:Label>
              </td>
               <td background="Images/borderRight.gif" width="21">
                        &nbsp;</td>
          </tr>
