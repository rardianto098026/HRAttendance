...
(function($) {
	var lang = {
		...
		tr: {
			...
			months: [ "Ock", "Sub", "Mar", "Nis", "May", "Haz", "Tem", "Agu", "Eyl", "Ekm", "Kas", "Arlk" ]
		},
		es: {
		...
		cz: {
			days: ['Ne', 'Po', 'Út', 'St', 'Ct', 'Pá', 'So'],
			months: [ "Led", "Úno", "Bre", "Dub", "Kve", "Cer", "Cvc", "Srp", "Zár", "Ríj", "Lis", "Pro" ],
			format: 'DD.MM.YYYY hh:mm'
		},
		fr: {
		...
		hu: {
			...
			prevMonth: 'Elozo hónap',
			nextMonth: 'Következo hónap',
			today: 'Ma'
		},
		fa: {
			days: ['??????', '??????', '?? ????', '????????', '??? ????', '????', '????'],
		...
		lv: {
			days: ['Sv', 'P', 'O', 'T', 'C', 'P', 'S'],
			months: [ "Jan", "Feb", "Mar", "Apr", "Mai", "Jun", "Jul", "Avg", "Sep", "Okt", "Nov", "Dec" ],
			format: 'DD.MM.YYYY hh:mm'
		},
		lt: {
			days: ['Pr', 'A', 'T', 'K', 'P', 'Š', 'S'],
			...
			sep: '-',
			format: 'YYYY-MM-DD hh:mm',
			prevMonth: 'Praeitas menesis',
			nextMonth: 'Sekantis menesis',
			today: 'Šiandien'
		}
	};
	/* ----- */
