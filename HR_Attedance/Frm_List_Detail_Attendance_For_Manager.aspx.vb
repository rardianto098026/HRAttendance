Public Class Frm_List_Detail_Attendance_For_Manager
    ...
    Private Sub grid_Databinding()
        ...
        dtSelect = oSelect.f_SEL_LIST_ATTENDANCE_USER(_Date, _Month, lbEmplID.Text.ToString, _flagDate, _FlagMonth, Session("YearAttendance"))
    ...
    Private Sub grid_Export()
        ...
        Dim dtSelect As New DataTable
        dtSelect = oSelect.f_SEL_LIST_ATTENDANCE_USER_EXPORT_REPORT(_Date, _Month, lbEmplID.Text, _FlagMonth, _flagDate, Session("YearAttendance"))
    ...
    Sub UserLoad()
        Dim dtSelect As New DataTable
        dtSelect = oSelect.f_SEL_LIST_ATTENDANCE_USER_LOAD(lbEmplID.Text.ToString, Session("YearAttendance"))
    ...
    Protected Sub Frm_List_ABSEN_USER_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            lbEmplID.Text = Request.QueryString("EmployeeID").ToString()
    ...
    Sub GetStatsCWH()
        ...
        dtStat = oSelect.f_SEL_GET_STATUS_APPROVED(lblQuarter.Text, Session("YearAttendance").ToString(), lbEmplID.Text)
