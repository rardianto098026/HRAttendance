<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Frm_Upload_Data_Employee.aspx.vb" Inherits="HR_Attedance.Frm_Upload_Data_Employee" %>
	...
	<table width="1200px" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <tr>
                    ...
                    <td class="style1" height="30" align ="left">
                         &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                        Attach File Non FTE : <asp:FileUpload ID="txtUpload_NonFTE" runat="server" CssClass="textbox" Width="450px" /> 
                        &nbsp; <asp:Label ID="lblErr_Upload_NonFTE" runat="server" Text="." Visible="false" ForeColor="Red"></asp:Label>
                        </td>
                    <td background="Images/borderRight.gif" width="21">
                        &nbsp;</td>
              </tr>
