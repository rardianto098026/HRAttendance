<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Frm_Upload_CWH_for_Employee.aspx.vb" Inherits="HR_Attedance.Frm_Upload_CWH_for_Employee" %>
        ...
        <tr>
                    ...
                    <td class="style1" height="30" align ="left">
                        <asp:Label ID="Label2" runat="server">Name</asp:Label>    
                         <asp:DropDownList ID="txtUserName" runat="server" CssClass="ui-widget" style="margin-left:38px"> 
                         </asp:DropDownList>
                    </td>
                    <td background="Images/borderRight.gif" width="21">
                        &nbsp;</td>
              ...
              <tr>
                    ...
                    <td class="style1" height="30" align ="left">
                        ...
                        <asp:DropDownList ID="ddlYear" runat ="server" style="margin-left:45px">
              ...
              <tr>
                    <td background="Images/borderleft.gif" width="21">
                        &nbsp;</td>
                    <td class="style1" height="30" align ="left">
                        <asp:Label ID="Label1" runat="server">Quarter</asp:Label> 
                        <asp:DropDownList ID="ddlQuarter" AutoPostBack="true" OnSelectedIndexChanged="ddlQuarter_SelectedIndexChanged" runat ="server" style="margin-left:28px">
                            <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                        ...
                        <asp:Textbox ID="txtMonth" runat="server" style="margin-left:10px" Enabled="false" Width="200px"></asp:Textbox>
                    </td>
                    <td background="Images/borderRight.gif" width="21">
                        &nbsp;</td>
              </tr>
              ...
              <br />
                        <asp:Label ID="lblstatExpired" runat="server" STYLE="margin-left:8px" Visible="false"></asp:Label>
