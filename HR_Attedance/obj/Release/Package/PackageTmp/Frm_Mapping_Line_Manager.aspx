<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Frm_Mapping_Line_Manager.aspx.vb" Inherits="HR_Attedance.Frm_Mapping_Line_Manager" %>
...
<body>
    ...
    <div>
         ...
         <h1 align="center"> List Line Manager <%--<asp:Label ID="lblYears" runat="server"></asp:Label>--%></h1>
        <br />
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td align ="right" class="auto-style1">
                                            <asp:CheckBox ID="ChkMngr1" runat="server" Text="" TextAlign=left />
                                        </td>
                                        <td align ="left" class="auto-style1">
                                            Manager Name <asp:Label ID="lblMngrID1" runat="server" Text="." Visible="false" ForeColor="Red"></asp:Label>
                                        </td>
                                         <td align ="left" width="10px" class="auto-style1">
                                            :
                                        </td>
                                        <td width="75%"  align ="left" class="auto-style1">
                                            <asp:DropDownList ID="txtMngrID" runat="server" Width="300px"></asp:DropDownList>
                                            <%--<asp:TextBox ID="txtEmplID" runat="server" CssClass="textbox"></asp:TextBox>--%>
                                            &nbsp; <asp:Label ID="lblMngrID2" runat="server" Text="." Visible="false" ForeColor="Red"></asp:Label>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td align ="left" height="20px" class="style2">
                                            Employee Name <asp:Label ID="lblEmplID1" runat="server" Text="." Visible="false" ForeColor="Red"></asp:Label>
                                        </td>
                                         <td align ="left" width="10px">
                                            :
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="75%"  align ="left">
                                            <asp:LinkButton ID="Search" runat="server" Width="50px" style="margin-left:25px; height: 15px;" >SEARCH</asp:LinkButton>
                                            <asp:LinkButton ID="Export" runat="server" Width="50px" style="margin-left:30px; height: 15px;" >EXPORT</asp:LinkButton>
                                            <asp:LinkButton ID="AddLine" runat="server" Width="500px" style="margin-left:30px; height: 15px;">ADD NEW TEAM</asp:LinkButton>
                                        </td>
                                          </tr>
                 ...
                 <asp:DataGrid ID="dgRekeningKoran" runat="server" 
                            ...
                            <Columns>	
                               ...
                               <%-- <asp:BoundColumn  DataField="idx" HeaderText="idx" HeaderStyle-Width="1px" SortExpression="idx ASC" Visible="False">
                                ...
                                <asp:BoundColumn  DataField="EmployeeID_Manager" HeaderText="Manager ID" HeaderStyle-Width="70px" SortExpression="Entity ASC" Visible="true">
                                <HeaderStyle Width="70px"></HeaderStyle>
                                </asp:BoundColumn>
