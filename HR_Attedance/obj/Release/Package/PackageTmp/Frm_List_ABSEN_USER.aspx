<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Frm_List_ABSEN_USER.aspx.vb" Inherits="HR_Attedance.Frm_List_ABSEN_USER" %>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="75%"  align ="left">
                                            <asp:TextBox ID="txtDate" runat="server" CssClass="textbox" Width="100px"></asp:TextBox>
                                     ...
                                     <tr>
                                        ...
                                        <td width="75%"  align ="left">
                                            <asp:DropDownList runat="server" ID="ddlQuarter" AutoPostBack="true" OnSelectedIndexChanged="ddlQuarter_SelectedIndexChanged" Width="100px">
                                    ...
                                    <tr>
                                        ...
                                        <td width="75%"  align ="left">
                                            <asp:Dropdownlist ID="ddlMonth" runat="server" OnSelectedIndexChanged="ddlMonth_SelectedIndexChanged" AutoPostBack="true" Width="100px">
                                    ...
                                    <tr>
                                        ...
                                        <td width="75%"  align ="left">
                                            ...
                                            <asp:LinkButton ID="ListCWH" runat="server" Width="130px" style="margin-left:8px; height: 15px;" >LIST DOCUMENT CWH</asp:LinkButton>
                                            <asp:LinkButton ID="LinkButton1" runat="server" Width="170px" style="margin-left:8px; " >UPLOAD DOCUMENT CWH</asp:LinkButton>
