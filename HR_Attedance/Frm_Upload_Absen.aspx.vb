...
Public Class Frm_Upload_Absen
    ...
    Public Function UploadData() As String
        ...
        Try
            ...
            da = New OleDb.OleDbDataAdapter("Select * from [Sheet1$A1:AQ1000000]", conn)
            ...
            If dtImport.Rows.Count > 0 Then
                ...
                For Each dr As DataRow In dtImport.Rows
                    oInsert.f_Insert_TRN_ATTENDANCE_AJENG(dr("Name").ToString, dr("Access Card No").ToString, dr("First Sign In").ToString,
                                                dr("Last Sign Out").ToString, Session("UserID").ToString, uploadid)
                    'oSelect.f_CHECK_DAYS_ATTENDANCE(uploadid, dr("Access Card No").ToString)
