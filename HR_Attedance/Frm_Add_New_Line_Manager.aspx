<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Frm_Add_New_Line_Manager.aspx.vb" Inherits="HR_Attedance.Frm_Add_New_Line_Manager" %>
         ...
         <table width="100%" align="center" cellpadding="0" cellspacing="0">
          <tr>
              ...
              <td class="style1" height="30" align ="left">
                  ...
                  <asp:TextBox ID="EmplIDManager2" runat="server" style="margin-left:60px" Width="300px" ReadOnly="true"></asp:TextBox>
              </td>
          ...
          <tr>
              ...
              <td class="style1" height="30" align ="left">
                  ...
                  <asp:DropDownList ID="EmplNameManager2" runat="server" style="margin-left:96px" Width="304px" AutoPostBack="True" OnSelectedIndexChanged="ddl_Manager_SelectedIndexChanged"></asp:DropDownList>
             ...
             <tr>
              ...
              <td class="style1" height="30" align ="left">
                  ...
                  <asp:TextBox ID="EmailManager2" runat="server" style="margin-left:97px" Width="300px" ReadOnly="true"></asp:TextBox>
              </td>
               <td background="Images/borderRight.gif" width="21">
                        &nbsp;</td>
          </tr>
             <tr>
              ...
              <td class="style1" height="30" align ="left">
                  ...
                  <asp:TextBox ID="lblEmployeeID2" runat="server" style="margin-left:109px" Width="300px" ReadOnly="true"></asp:TextBox>
          ...
          <tr>
              ...
              <td class="auto-style2" align ="left">
                  ...
                  <asp:DropDownList ID="ddlEmployeeName2" runat="server" style="margin-left:89px" Width="304px" AutoPostBack="True" OnSelectedIndexChanged="ddl_Employee_SelectedIndexChanged"></asp:DropDownList>
             ...
             <tr>
              ...
              <td class="style1" height="30" align ="left">
                  ...
                  <asp:TextBox ID="Email2" runat="server" style="margin-left:148px" Width="300px" ReadOnly="true"></asp:TextBox>
          ...
          <tr>
              ...
              <td class="auto-style2" align ="left">
                  ...
                  <asp:TextBox ID="lblEntity2" runat="server" style="margin-left:148px" Width="300px" ReadOnly="true"></asp:TextBox>
             ...
             <tr>
              ...
              <td class="auto-style2" align ="left">
                  ...
                  <asp:TextBox ID="lblWorkerType2" runat="server" style="margin-left:110px" Width="300px" ReadOnly="true"></asp:TextBox>
