Public Class Frm_List_ABSEN_ADMIN
    ...
    Private Sub grid_Databinding()
        ...
        dtSelect = oSelect.f_SEL_LIST_ATTENDANCE_ADMIN(Session("Entity").ToString, _Access, _Month, _NameEmplo, _FlagMonth, _flagAccessCard, _flagNameEmplo, _flagEmplID, _EmplID, Session("Role"))
