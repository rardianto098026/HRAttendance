<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Frm_List_Attendance_for_Manager.aspx.vb" Inherits="HR_Attedance.Frm_List_Attendance_for_Manager" %>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="75%"  align ="left">
                                            <asp:DropDownList ID="txtEmplID" runat="server"></asp:DropDownList>
                                    ...
                                    <tr>
                                        ...
                                        <td width="75%"  align ="left">
                                            ...
                                            <%--<asp:LinkButton ID="Export" runat="server" Width="50px" style="margin-left:15px; height: 15px;" >EXPORT</asp:LinkButton>--%>
                                        </td>
                                          </tr>
