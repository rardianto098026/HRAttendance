...
Imports System.IO
Public Class Frm_Upload_CWH_for_HR
    ...
    End Sub
    Sub LoadEmployee()
        If Session("Role").ToString().ToUpper() = "ADMIN" Or Session("Role").ToString().ToUpper() = "SUPER ADMIN" Then
    ...
    Private Function UploadExcel() As String
        ...
        Try
            ...
            Dim new_path As String = FolderCWH + "\" + ddlYear.SelectedItem.Text + "\" + ddlQuarter.SelectedItem.Text + "\" + Session("ShortEntity").ToString() + "\" + EmployeeID + "\" + filename
            Dim DirecPath As String = FolderCWH + "\" + ddlYear.SelectedItem.Text + "\" + ddlQuarter.SelectedItem.Text + "\" + Session("ShortEntity").ToString() + "\" + EmployeeID + "\"
            ...
            If Path.GetExtension(strFileName).ToUpper = ".PDF" Then
                ...
                Dim dtCheck As New DataTable()
                dtCheck = oSelect.f_SEL_MST_EMPLOYEE_USER(Session("EMPLNUMBER").ToString())
                If dtCheck.Rows.Count > 0 Then
                ...
                oSelect.f_SEND_EMAIL_NOTIF_CWH_TO_HR(txtUserName.SelectedItem.Text, EmployeeID, "", shortEntity, "", ddlYear.SelectedItem.Text, ddlQuarter.SelectedItem.Text, filename, uploadid, Session("UserID").ToString())
