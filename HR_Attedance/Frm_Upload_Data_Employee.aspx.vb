...
Public Class Frm_Upload_Data_Employee
        ...
        Try
            ...
            If dtImport.Rows.Count > 0 Then
                ...
                For Each dr As DataRow In dtImport.Rows
                    oInsert.f_INS_MASTER_DATA_EMPLOYEE(dr("Person Number").ToString, dr("Full Name").ToString,
                                                    dr("Primary E-Mail").ToString, dr("Entity").ToString,
